...
//  Nutby
//
//  Created by Diren Akgöz on 03.06.21.
//
...
struct AddBabyView: View {
    ...
    var body: some View {
        VStack(spacing: 25) {
            ...
            Baby_Information()
            Baby_EnterFields(vm: vm)
            Spacer()
        }
    }
}

struct Baby_Information: View {
    var body : some View {
        ZStack {
    ...
    var body: some View {
        VStack {
            ...
            HStack {
                ...
                Image(uiImage: image!.withTintColor(vi.getDarkBlueUIC()))
                    .resizable()
            ...
            HStack(spacing: 100) {
                ...
                Button {
                    if (allPropertiesSelected()) {
                        vm.addBaby(fn: firstname, ln: lastname, g: genderToggle, bD: birthDate, i: image!)
                        resetVars()
                    }
                } label: {
                    Text("Speichern")
